...
//64 words 63 index 
    ...
    public static void main(String[] args) {
        ...
        System.out.println(gallows[0]);
                ...
                System.out.print("\n THIS IS TO FUCKING DEBUG: " + wordAnswer);
        ...
        // in such that this placeholderarray will be updated with correct guessed characters
            ...
            // this checks after every guess consistently (end of while loop) if the placeholder updated word is 
            ...
            // with a break; syntax and with a print of the winning word.
                if (Arrays.equals(arrayWordInPlay, placeHolderArray)) {
                    System.out.println("You win! The word was: " + wordAnswer);
                    System.exit(0);
                }
        ...
        // if the guess is incorrect it does not update and procedes to the code below (outside THIS for loop, but IN main while loop)
            for (int i = 0; i < arrayWordInPlay.length; i++){

                // checks the above scanner input (guessInput - L177) with a functionality that only checks the first 
